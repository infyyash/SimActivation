...
//    @Digits(integer = 13,fraction = 0, message = "Invalid details!! SIM Number should be of 13 digits.")
    ...
    @Valid
    private SimOffersDto simOffersDto;
    ...
    public SimOffersDto getSimOffersDto() {
        return simOffersDto;
    }

    public void setSimOffersDto(SimOffersDto simOffersDto) {
        this.simOffersDto = simOffersDto;
    }
}
